...
public class QuittanceCreatedEvent {
    ...
    public QuittanceCreatedEvent() {
    }

    public QuittanceCreatedEvent(Long quittanceId, Long locataireId, String periode, BigDecimal montant) {
